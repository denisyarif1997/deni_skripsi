...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-fw fa-plus"></i> Tambah Data Pendaftar</h6>
    </div>
	
	<form method="post" action="<?=base_url('')?>Pendaftar/store" enctype="multipart/form-data">
		<div class="card-body">
			<div class="row">
